  ...
  return (
    <div className='bg-[#F7F2D6] font-poppins text-gray-800 dark:bg-gray-900 dark:text-gray-200'>
      <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <Link href='/' className='mt-6 text-white  flex items-center gap-2 font-medium bg-blue-500 px-4 py-2 rounded-lg transition-colors duration-300 hover:bg-blue-600'>
         <MoveLeft />
         Home
        </Link>
      </div>
